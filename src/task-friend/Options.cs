...
namespace task_friend {
  public class Options {
    ...
    [Option( 'c', "concurrent", Required = false, HelpText = "Number of concurrent tasks (default is 10)", DefaultValue = 10)]
    public int Threads { get; set; }

    [Option( 't', "timeout", Required = false, HelpText = "Timeout in milliseconds (default is 60000)", DefaultValue = 60000 )]
    ...
    public string GetUsage() {
      ...
      help.AddPreOptionsLine( "Usage: task-friend.exe -i c:\\myinput.txt -c 10 [-d] [-s] [-b] [-t milliseconds]" );
